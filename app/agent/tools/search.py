...
async def search_games(
    ...
    - 결과는 많이 평가된(인기) 순이며 최대 30개다. 이 사용자에게 맞는 순서가 아니므로, 판정을 통과한
      후보 중에서 genres·themes·summary·playtime_hours를 보고 질문과 취향에 맞는 게임을 고른다.
    - 가격·사양은 아직 확인되지 않았으므로 get_prices와 assess_hardware로 판정한 뒤 추천한다.
